...
class Game(object):
    ...
    def main(self, screen):
        ...
        px = rd.randint(50, self.tilemap.px_width - 50)
        py = rd.randint(50, self.tilemap.px_height - 50)
        self.knife2 = Knife('Knife 2', level, (px, py), self.item_s)
        ...
        while self.player.is_alive and not self.hard_quit:
            # restrain to 30fps
    ...
    def blit_game_info(self, screen):
        ...
        screen.blit(self.player.hp_t, (340, 18))
        screen.blit(self.player.attk_t, (340, 29))
        screen.blit(self.player.dfnc_t, (340, 40))
        self.player.blit_inventory(self)
...
class Equipment(Thing):
    ...
    def ask_pickup(self, dt, game):
        ...
        tab = FNT['sml'].render('Press <TAB> to change.', 1, CLR['blk'])
        game.screen.fill((CLR['blk']))
        game.tilemap.draw(game.screen)
        game.screen.blit(pickup, (152, 160))
        game.screen.blit(tab, (152, 180))
